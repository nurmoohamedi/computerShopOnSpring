...
public class Case {
    ...
    public Case(int id, String processor, String ram, String video_card, String hard_drive, String power_supply) {
        this.id = id;
    ...
    public static List<Case> getCases(){
        List<Case> computerCases = new ArrayList<>();

        computerCases.add(new Case(1,"intel i5","8gb","Nvidia Geforce GTX","512gb SSD","225WT"));
        computerCases.add(new Case(2,"intel i7","16gb","Nvidia Geforce GTX 1650","1Tb SSD","300WT"));
        computerCases.add(new Case(3,"intel i9","32gb","Nvidia Geforce GTX TFI","2Tb SSD","225WT"));
